/* $Id: disco_svc_md_association_add.c,v 1.0 2005/10/14 15:17:55 fpeters Exp $
 *
 ...
 * @short_description: &lt;disco:SvcMDAssociationAdd&gt;
 *
 * <figure><title>Schema fragment for disco:SvcMDAssociationAdd</title>
...
class_init(LassoIdWsf2DiscoSvcMDAssociationAddClass *klass, void *unused G_GNUC_UNUSED)
{
	...
	lasso_node_class_set_nodename(nclass, "SvcMDAssociationAdd");
...
lasso_idwsf2_disco_svc_md_association_add_get_type()
{
	...
	if (!this_type) {
		static const GTypeInfo this_info = {
			sizeof (LassoIdWsf2DiscoSvcMDAssociationAddClass),
			NULL,
			NULL,
		...
		this_type = g_type_register_static(LASSO_TYPE_NODE,
				"LassoIdWsf2DiscoSvcMDAssociationAdd", &this_info, 0);
	}
	return this_type;
}
 ...
 *
 * Return value: a newly created #LassoIdWsf2DiscoSvcMDAssociationAdd object
 **/
LassoIdWsf2DiscoSvcMDAssociationAdd*
lasso_idwsf2_disco_svc_md_association_add_new()
{
	return g_object_new(LASSO_TYPE_IDWSF2_DISCO_SVC_MD_ASSOCIATION_ADD, NULL);
}
